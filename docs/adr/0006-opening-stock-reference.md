# ADR 0006 — Base inicial de estoque
...
## Consequências
A Fase 2 deve disponibilizar ajustes positivos/negativos com motivo, data, usuário e valores anteriores/posteriores, além de correção de custo auditada. Não alterar diretamente movimentos confirmados ou CMV histórico. Carga e interface implementadas na Fase 2.
